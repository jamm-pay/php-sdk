...
class HealthcheckApi
{
     ...
     * @return \OpenAPI\Client\Model\V1PingResponse|\OpenAPI\Client\Model\GooglerpcStatus
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\V1PingResponse|\OpenAPI\Client\Model\GooglerpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\V1PingResponse',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\V1PingResponse';
        $request = $this->pingRequest($contentType);
