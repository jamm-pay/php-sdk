 ...
 *
 * @category Class
 * @description Charge represents a charge information for the customer.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V1Charge implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'v1Charge';
     ...
     * Sets id
     *
     * @param string|null $id 決済ID (例: trx-1234567890)  @gotags: validate:\"required\"
     *
     * @return self
     */
