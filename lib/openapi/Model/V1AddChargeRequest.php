...
/**
 * V1AddChargeRequest Class Doc Comment
 *
 * @category Class
 * @description This message represents a request to add a charge to an existing customer. It contains all necessary information to process a new payment transaction.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V1AddChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1AddChargeRequest';
